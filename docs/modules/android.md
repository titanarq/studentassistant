...
- Capture screen: CameraX preview, mic streaming (AudioRecord 16 kHz mono PCM16) over the
  session WebSocket, buttons (Capturar, Importante, Libro/Apuntes, Terminar), live transcript,
