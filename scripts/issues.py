#!/usr/bin/env python3
"""Shim: this module lives in `agent_os/agent_os/issues.py` (`agent_os/docs/adr/2026-09-21-the-
...
os.execvp(agent_os_python(), [agent_os_python(), "-m", "agent_os.issues", *sys.argv[1:]])
